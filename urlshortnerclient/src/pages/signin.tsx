...
export default function Login() {
    return (
        ...
        <div className="flex items-center justify-between mt-4">
            ...
            <Link href="" className="text-xs text-center uppercase font-semibold text-gray-400 hover:underline">
        ...
        <div className="flex items-center mt-6 -mx-2">
            <button type="button" className="flex items-center justify-center w-full px-6 py-3 mx-2 text-lg font-medium text-white transition-colors duration-300 transform bg-blue-700 rounded-md hover:bg-blue-400 focus:bg-blue-400 focus:outline-none" onClick={() => signIn()}>
            ...
            <Link href="" className="p-2 mx-2 text-sm font-medium text-gray-500 transition-colors duration-300 transform bg-gray-300 rounded-lg hover:bg-gray-200">
