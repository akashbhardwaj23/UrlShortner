...
export default function Login() {
    ...
    return (
        ...
        <div className="flex items-center mt-6 -mx-2">
            ...
            <Link href="" className="p-2 mx-2 text-sm font-medium text-gray-500 transition-colors duration-300 transform bg-gray-300 rounded-lg hover:bg-gray-200" onClick={() => signIn("twitter", {callbackUrl : "/"})}>
